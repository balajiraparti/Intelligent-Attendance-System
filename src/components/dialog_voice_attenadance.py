...
@st.dialog('Voice Attenandance')
def voice_attendance_dialog(selected_subject_id):
    st.write("Record audio of students saying i am present. teh AI will recognize students")
    audio_data=None
    ...
    if st.session_state.get('voice_attendance_results'):
           st.divider()
           df_result,logs=st.session_state.voice_attendance_results
